...
- 按界面顺序共享并连续扣减采购余额。
- 所有管理员和操作员都可发布不可变的超收规则版本，按短尾/中尾/长尾配置绝对超收数量并维护允许仓库白名单。
...
4. 如需自动超收，由任一管理员或操作员进入“超收规则”发布版本；仓库留空表示所有仓库都不允许超收。
